...
$sql= "SELECT * FROM ticket_book WHERE UserName='$data'";
...
<head>
    ...
    <title>Passenger|Notification</title>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="content" style="background-image: url(../img/slider\ 1.jpg);">
                <div class="container-fluid">
                    <div class="card  ">
                                <div class="card-header bg-primary text-white"><i class="fa fa-book"></i> BOOKED TOUR
                                </div>
                                <div class="card-body">
