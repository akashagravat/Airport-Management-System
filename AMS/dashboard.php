                            ...
                            <div class="row">
                                <div class="card-deck">
                                    <div class="card" style="background-image: url(../img/slider\ 6.jpg); ">
                                        ...
                                        <div class="card-body">
                                            <h3 class="card-title">
                                                <i class="nc-icon nc-circle-09"></i> Update Profile
                                            </h3>
                                            <p class="card-text mt-4">In This Pannel You Can Update Your Personal Details</p>
                                        </div>
                                    ...
                                    <div class="card" style="background-image: url(../img/slider\ 6.jpg); ">
                                        <div class="card-body">
                                            <h3 class="card-title">
                                                <i class="nc-icon nc-atom"></i> All Routes
                                            </h3>
                                            <p class="card-text mt-4">In This Pannel You Know About Routes</p>
                                        </div>
                                        <div class="card-footer">
                                            <a href="All Route.php">
                                                <button type="button" class="btn btn-primary">Know Routes</button>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="card" style="background-image: url(../img/slider\ 6.jpg); ">
                                        <div class="card-body">
                                            <h3 class="card-title">
                                                <i class="nc-icon nc-notes"></i> Book Tour
                                            </h3>
                                            <p class="card-text mt-4">In This Pannel You Can Book a Tour</p>
                                        </div>
                                        <div class="card-footer">
                                            <a href="BookTour.php">
