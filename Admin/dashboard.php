    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="content" style="background-image: url(../img/slider\ 1.jpg);">
                <div class="container-fluid">
                    <div class="row mt-5">
                        <div class="container-fluid container-fullw bg-white mt-5">
                            <div class="row">
                                <div class="card-deck">
                                    <div class="card" style="background-image: url(../img/slider\ 6.jpg); ">

                                        <div class="card-body">
                                            <h3 class="card-title">
                                                <i class="nc-icon nc-circle-09"></i>All Users</h3>
                                            <p class="card-text mt-4">In This Pannel You can show all users</p>
                                        </div>
                                        <div class="card-footer">
                                            <a href="Users.php">
                                            <button type="button" class="btn btn-primary">All Users</button></a>
                                        </div>
                                    </div>
                                    <div class="card" style="background-image: url(../img/slider\ 6.jpg); ">
                                        <div class="card-body">
                                            <h3 class="card-title">
                                                <i class="nc-icon nc-atom"></i> All Routes</h3>
                                            <p class="card-text mt-4">In This Pannel You Know About Routes</p>
                                        </div>
                                        <div class="card-footer">
                                            <a href="route.php">
                                            <button type="button" class="btn btn-primary">Know Routes</button></a>
                                        </div>
                                    </div>
                                    <div class="card" style="background-image: url(../img/slider\ 6.jpg); ">
                                        <div class="card-body">
                                            <h3 class="card-title">
                                                <i class="nc-icon nc-notes"></i> Booked Tour</h3>
                                            <p class="card-text mt-4">In This Pannel You can view all booked tickets</p>
                                        </div>
                                        <div class="card-footer">
                                            <a href="BookeTicket.php">
