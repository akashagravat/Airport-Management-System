...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM admin WHERE UserName='" . $_POST['uname'] . "' and password='" . $_POST['ps'] . "'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $log = "insert into adminlog(UserName,Date,Time) values('" . $_SESSION['uname'] . "','" . $_SESSION['dt'] . "','" . $_SESSION['dt2'] . "')";
...
<body style="background-image: url(../img/slider\ 1.jpg);">
            ...
            <ul class="navbar-nav mr-auto ">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item active" href="Login.php">Admin Login<span class="sr-only">(current)</span></a>
        ...
        <div class="row">
            <div class="col">
                <div class="card" style="background-color: lightskyblue;">
                    <div class="card-header bg-primary text-white "><i class="fa fa-user"></i> AMS|ADMIN LOGIN
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            <caption>
                            ...
                            <div class="input-group mt-3">
                                ...
                                <input type="text" class="form-control mr-5" aria-label="Large" name="uname" aria-describedby="inputGroup-sizing-default" placeholder="Enter Your User Name" autofocus required>
                            </div>
                    ...
                    <center>
                       ...
                       <a href="../index.html"> <button type="button" class="btn btn-secondary mx-5 my-5 float-right "><i class="fa fa-close"></i>Close</button></a>
                    </center>
    ...
    <footer class="footer mt-3">
        <ul class="nav-foot">
            ...
            <p class="float-right">&copy;
                <script>
                    document.write(new Date().getFullYear())
                </script>Designed by Akash Agravat
            </p>
        </ul>
    </footer>
