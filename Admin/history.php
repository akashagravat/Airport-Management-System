...
$data = "SELECT * FROM userlog";
$result = mysqli_query($conn, $data); 
$data1 = "SELECT * FROM adminlog";
...
<head>
    ...
    <title>Admin|LoginHistory</title>
            ...
            <div class="content" style="background-image: url(../img/slider\ 1.jpg);">
                <div class="container-fluid">
                    <div class="row ">
                        <div class="col">
                        <div class="card  ">
                                <div class="card-header bg-primary text-white"><i class="fa fa-history"></i> Passenger Login History
                                </div>
                                <div class="card-body">
...
?>
                    ...
                    <div class="card  ">
                                <div class="card-header bg-success text-white"><i class="fa fa-history"></i> Admin Login History
                                </div>
                                <div class="card-body">
                            <table class="table table-hover">
                                <thead>
