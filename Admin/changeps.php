...
if(isset($_POST['submit'])){
    $nps=$_REQUEST['nps'];
    if($nps != ""){
    $alt= "Update admin set Password='$nps' where UserName='$data'" ;
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="UserName" name="eml" value="<?php echo $data ?>" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="old password" name="ps" value="<?php echo $ps ?>" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
