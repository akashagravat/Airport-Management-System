...
$sql= "SELECT * FROM psglogout";
$result = mysqli_query($conn, $sql); 
$sql1= "SELECT * FROM adminogout";
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="content" style="background-image: url(../img/slider\ 1.jpg);">
                <div class="container-fluid">
                    <div class="card  ">
                                <div class="card-header bg-primary text-white"><i class="fa fa-history"></i> User Logout History
                                </div>
                                <div class="card-body">
...
?>
                        ...
                        <div class="card  ">
                                <div class="card-header bg-warning text-white"><i class="fa fa-history"></i> Admin Logout History
                                </div>
                                <div class="card-body">
                            <table class="table table-hover">
                                <thead>
